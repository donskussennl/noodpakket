...
onMounted(() => {
  // alle hygiene opties aan
  intake.value.hygiene = Object.keys(HYGIENE_PRICES) as HygieneOption[]

  // alle tools aan
  intake.value.tools = Object.keys(TOOL_PRICES) as ToolsOption[]

  // voorbeeld: deluxe = altijd flightbag + food 'buy'
